...
//				}
	...
	private void processBatch(List<TPartStoredProcedureTask> batchedTasks) {
		StoredProcedureCall call = new StoredProcedureCall(-1, -1, -1, new Object[]{});
		TPartStoredProcedureTask task_for_replicate = createStoredProcedureTask(call);
		// Insert the batch of tasks
		inserter.insertBatch(graph, batchedTasks,task_for_replicate);
