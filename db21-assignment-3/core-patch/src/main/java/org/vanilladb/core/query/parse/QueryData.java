...
public class QueryData {
	...
	public QueryData(Set<String> projFields, Set<String> tables, Predicate pred,
			Set<String> groupFields, Set<AggregationFn> aggFn, List<String> sortFields, List<Integer> sortDirs, boolean needExplain) {
	...
	/**
	 * Returns whether we need to perform "explain" in this query.
	 * 
	 * @return we need to explain or not;
	 */
